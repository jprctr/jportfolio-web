...
### Build & Architecture
The development process involved close coordination with eBay technical teams to define the necessary data models for the internal APIs created to support views such as the homescreen widgets and the Payments. On the front-end we implemented efficient data refresh mechanisms to keep the D3-in-react charts responsive and up-to-date with configuration and filter selections, while also maintaining a consisting design language and comfortable touch targets for controls.
