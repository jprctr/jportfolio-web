...
### Design Process
1. Conducted extensive meetings with U.C. Riverside biology faculty and their colleagues in the field to identify the most useful and relevant output views
2. Collaborated with academic specialists to understand their specific visualization needs
3. Designed a flexible UI that enabled prefiltering complex data across multiple dimensions
4. Optimized visualization tools specifically for biological data types

### Development Process
1. Built an Electron application supporting Windows, Mac OS, and Linux platforms
2. Developed a Python-based loader to efficiently handle both JSON and binary-formatted BIOM files
3. Implemented efficient data loading without infrastructure costs or data custody concerns
4. Managed filtering and UI updates carefully to maintain responsive performance with large datasets
